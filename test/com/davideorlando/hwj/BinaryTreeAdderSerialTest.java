...
public class BinaryTreeAdderSerialTest {
	...
	public void test_ComputeOnerousSum_SommaSuNull() {
		assertEquals(0, new BinaryTreeAdderSerial().computeOnerousSum(null));
	}
	
	@Test
	public void test_ComputeOnerousSum_SommaSuFogliaConValoreUno() {
		assertEquals(1, new BinaryTreeAdderSerial().computeOnerousSum(fogliaConValoreUno));
	}
	...
	public void test_ComputeOnerousSum_SommaSuAlberoValoreDueFiglioDestro() {
		...
		assertEquals(2, new BinaryTreeAdderSerial().computeOnerousSum(nodoConValoreUnoFiglioDestro));
	}
	
	@Test
	public void test_ComputeOnerousSum_SommaSuAlberoValoreDueFiglioSinistro() {
		Node nodoConValore1FiglioSinistro = new SimpleNode(fogliaConValoreUno,null,2);
		assertEquals(3, new BinaryTreeAdderSerial().computeOnerousSum(nodoConValore1FiglioSinistro));
	}
	...
	public void test_ComputeOnerousSum_SommaSuAlberoSommaQuattro() {
		...
		assertEquals(4, new BinaryTreeAdderSerial().computeOnerousSum(alberoSommaQuattro));
	}
	...
	public void test_ComputeOnerousSum_SommaSuAlberoSommaMille() {
		...
		assertEquals(1000, new BinaryTreeAdderSerial().computeOnerousSum(mille));
	}
	...
	public void test_ComputeOnerousSum_SommaSuAlberoSommaDiecimila() {
		...
		assertEquals(10000, new BinaryTreeAdderSerial().computeOnerousSum(diecimila));
	}
}
